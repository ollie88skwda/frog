...
```ts
// Framework-free, portable uuid v4. Node 19+/web expose globalThis.crypto.randomUUID;
// React Native (Hermes) does NOT, so fall back to a self-contained v4 generator.
